...
PARAMS = [
    ("web_debranding.new_name", _("WWW")),
    ("web_debranding.new_title", _("WWW")),
    ("web_debranding.new_website", "ethiotelecom.com"),
    ("web_debranding.new_documentation_website", "https://www.com/documentation/"),
